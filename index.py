...
bottom_right2 = (top_left2[0] + rect2_width, top_left2[1] + rect2_width)
...
cv2.arrowedLine(image_rgb , arrow_start , arrow_end , (255,255,0),3, LipLength=0.05)
cv2.arrowedLine(image_rgb , arrow_end , arrow_start , (255,255,0),3, LipLength=0.05)
...
plt.title('Annotated Image with Regions, Centers, and Bi_Directiona; Height Arrow ')
plt.axis('off')
plt.show